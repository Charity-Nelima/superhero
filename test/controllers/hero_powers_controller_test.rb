...
class HeroPowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero_power" do
    assert_difference("HeroPower.count") do
      post hero_powers_url, params: { hero_power: { hero_id: @hero_power.hero_id, power_id: @hero_power.power_id, strength: @hero_power.strength } }, as: :json
    end
  ...
  test "should update hero_power" do
    patch hero_power_url(@hero_power), params: { hero_power: { hero_id: @hero_power.hero_id, power_id: @hero_power.power_id, strength: @hero_power.strength } }, as: :json
    assert_response :success
  end
